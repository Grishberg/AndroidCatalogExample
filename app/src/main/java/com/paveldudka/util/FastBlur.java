...
public class FastBlur {
    ...
    public void blur(final Context context, Bitmap bkg, final CustomImageView view) {
        ...
        blurJob = new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected void onPostExecute(Bitmap overlay) {
                ...
                if (!isCancelled() && overlay != null) {
                    Log.d(TAG, String.format("onPostExecute: w = %d, h = %d",
                            overlay.getWidth(), overlay.getHeight()));
                    view.drawBitmap(overlay);
...
//                        ((ImageView)view).setImageBitmap(overlay);
     ...
     * @return
     */
    public static Bitmap doBlur2(Bitmap sentBitmap, int radius, boolean canReuseInBitmap) {
